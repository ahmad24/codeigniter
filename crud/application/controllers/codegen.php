                ...
                foreach($label as $k => $v){
                    if($type[$k][0] != 'exclude'){
                        ...
                        if($type[$k][0] == 'textarea'){
                             $add_form[] = '
                                    div class="form-group"   <p>< class="col-sm-2 control-label" for="'.$k.'">'.$v.$required.'</label>                                
                                        <div class="col-sm-10" ><textarea class="form-control" id="'.$k.'" name="'.$k.'"><?php echo set_value(\''.$k.'\'); ?></textarea>
                                        <?php echo form_error(\''.$k.'\',\'<div>\',\'</div>\'); ?>
                                        </div></div>
                                        ';
                                        
                             $edit_form[] = '
                                        <div class="form-group"><label class="col-sm-2 control-label" for="'.$k.'">'.$v.$required.'</label>                                
                                        <div class="col-sm-10" ><textarea class="form-control" id="'.$k.'" name="'.$k.'"><?php echo $result->'.$k.' ?></textarea>
                                        <?php echo form_error(\''.$k.'\',\'<div>\',\'</div>\'); ?>
                                        </div></div>
                                        ';                                    
                            ...
                            $add_form[] = '
                                        <div class="form-group"><label class="col-sm-2 control-label" for="'.$k.'">'.$v.$required.'</label>                                
                                        <div class="col-sm-10" ><input class="form-control" id="'.$k.'" type="'.$type[$k][0].'" name="'.$k.'" value="<?php echo set_value(\''.$k.'\'); ?>"  />
                                        <?php echo form_error(\''.$k.'\',\'<div>\',\'</div>\'); ?>
                                        </div></div>
                                        ';
                            $edit_form[] = '
                                        <div class="form-group"><label class="col-sm-2 control-label" for="'.$k.'">'.$v.$required.'</label>                                
                                        <div class="col-sm-10" ><input class="form-control" id="'.$k.'" type="'.$type[$k][0].'" name="'.$k.'" value="<?php echo $result->'.$k.' ?>"  />
                                        <?php echo form_error(\''.$k.'\',\'<div>\',\'</div>\'); ?>
                                        </div></div>
                                        ';
                        }
